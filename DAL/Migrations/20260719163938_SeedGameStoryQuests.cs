...
('Arthur', 'The silver knight.', 'QuestGiver', 'AutumnPumpkin', 77.54412, -77.44301, 2.5, true),
...
BEGIN
    ...
    VALUES ('[Chapter 1] Speak with Elder Rowan', 'Talk to Elder Rowan in the Elf Forest.', 'Main', 'NotStarted', 'ElfForest', 1, 1, 50, 100, 0, 'Talk', 'Elder Rowan', 'Elf Forest', 'Elder Rowan', true) RETURNING ""QuestId"" INTO q_id;
    ...
    -- Q2
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 1] Gather White Flowers', 'Collect 3 White Flowers from the forest.', 'Main', 'NotStarted', 'ElfForest', 1, 3, 100, 80, 0, 'Collect', 'White Flower', 'Elf Forest', 'Elder Rowan', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q3
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""RewardSkillId"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 1] Deliver White Flowers', 'Deliver the gathered flowers to Elder Rowan.', 'Main', 'NotStarted', 'ElfForest', 1, 1, 50, 50, 0, (SELECT ""SkillId"" FROM ""Skills"" WHERE ""Name"" = 'Dark Poison Zone' LIMIT 1), 'Talk', 'Elder Rowan', 'Elf Forest', 'Elder Rowan', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q4
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 1] Equip Your Skill', 'Equip your first combat skill.', 'Main', 'NotStarted', 'ElfForest', 1, 1, 100, 100, 0, 'EquipSkill', 'Skill Panel', 'Elf Forest', 'Elder Rowan', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q5
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 1] Defeat Slimes', 'Kill 3 SlimeLittle monsters in the forest.', 'Main', 'NotStarted', 'ElfForest', 1, 3, 150, 150, 0, 'Defeat', 'SlimeLittle', 'Elf Forest', 'Elder Rowan', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q6
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""BossMonsterId"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 1] The Swamp Demon', 'Slay the Swamp Demon and obtain its Seal Book.', 'Main', 'NotStarted', 'ElfForest', 2, 1, 250, 500, 0, 'Defeat', 'SwampDemon', 'Deep Woods', 2, 'Elder Rowan', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q7
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 1] The Origin Tree', 'Talk to Lyra about the cursed Origin Tree and the 4 Seal Books.', 'Main', 'NotStarted', 'ElfForest', 2, 1, 100, 100, 0, 'Talk', 'Lyra', 'Origin Tree', 'Lyra', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q8
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 1] The Mysterious Figure', 'Follow the cloaked figure through the portal to Autumn Pumpkin.', 'Main', 'NotStarted', 'ElfForest', 2, 1, 50, 50, 0, 'Explore', 'Portal', 'Elf Forest', 'Mysterious Figure', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q9
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 2] Where Are We?', 'Teleported onto the beach, proceed to the castle and ask Elder Rowan where this is. After introductions, realize you have no money and ask if there is work to earn food.', 'Main', 'NotStarted', 'AutumnPumpkin', 3, 1, 50, 50, 0, 'Talk', 'Elder Rowan', 'Autumn Pumpkin', 'Elder Rowan', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    (npc_rowan2, q_id, 'Quest', 'Go talk to Fa, he is nearby and might need some help.', 3, true);

    -- Q10
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 2] Work for Food', 'Collect 8 Enchanted Pumpkins from the field and hand them over to farmer Fa.', 'Main', 'NotStarted', 'AutumnPumpkin', 3, 8, 100, 100, 0, 'Collect', 'Enchanted Pumpkin', 'Pumpkin Town', 'Fa', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    (npc_fa, q_id, 'None', 'Ah, Elder Rowan sent you? Good timing.', 1, true),
    (npc_fa, q_id, 'None', 'I need someone to help me harvest the fields.', 2, true),
    (npc_fa, q_id, 'Quest', 'Please collect 8 Enchanted Pumpkins for me.', 3, true);

    -- Q11
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 2] Delivery to the City', 'Help Fa deliver the harvested pumpkins to guard Tristan at the ruined city gate.', 'Main', 'NotStarted', 'AutumnPumpkin', 3, 1, 50, 50, 0, 'Talk', 'Tristan', 'City Gate', 'Fa', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    (npc_fa, q_id, 'None', 'Great job with the pumpkins! You are a hard worker.', 1, true),
    (npc_fa, q_id, 'None', 'Now, I need these delivered to the city gate.', 2, true),
    (npc_fa, q_id, 'Quest', 'Please take them to guard Tristan at the ruined city.', 3, true);
    ...
    VALUES ('[Chapter 2] The Silver Knight''s Training', 'Speak with Arthur and learn about his internal injuries and sealed power. Enter Dungeon ID 2 to train and level up your strength.', 'Main', 'NotStarted', 'AutumnPumpkin', 12, 1, 150, 150, 0, (SELECT ""SkillId"" FROM ""Skills"" WHERE ""Name"" = 'DarkExplosion' LIMIT 1), (SELECT ""ItemId"" FROM ""Items"" WHERE ""Name"" = 'Silver Necklace' LIMIT 1), 'Explore', 'Dungeon_2', 'Dungeon', 'Arthur', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    (npc_arthur, q_id, 'Quest', 'You must train in Dungeon 2 to level up and unlock your true potential. Go!', 3, true);

    -- Q14
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 2] Defeat the Evil Monsters', 'Receive the DarkExplosion skill and Silver Necklace from Arthur. Take his place to defeat 10 evil monsters in the Ruined City.', 'Main', 'NotStarted', 'AutumnPumpkin', 12, 10, 200, 200, 0, 'Defeat', 'Ghost/RobberAssassin/RedGuard/GoblinSpear/GoblinWarrior/RobberArcher/NecromancerCast', 'Ruined City', 'Arthur', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    (npc_arthur, q_id, 'None', 'Splendid! You have trained well and cleared the dungeon.', 1, true),
    (npc_arthur, q_id, 'None', 'As promised, take this DarkExplosion skill and Silver Necklace.', 2, true),
    (npc_arthur, q_id, 'Quest', 'Now, use your power to defeat 10 evil monsters in the Ruined City!', 3, true);

    -- Q15
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""BossMonsterId"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 2] Slay the Dragon', 'Turn in the quest and get Arthur''s recognition of your strength, receive quest to kill DragonBossIdle. Go kill dragon DragonBossIdle.', 'Main', 'NotStarted', 'AutumnPumpkin', 5, 1, 500, 1000, 0, 'Defeat', 'DragonBossIdle', 'Ruined City', 7, 'Arthur', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q16
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 2] The Frozen Threat', 'Talk to Arthur and receive the knight''s thanks, ask about the whereabouts of the ??? and he directs you to the frozen land devastated by the codex, go to Frozen Mountains.', 'Main', 'NotStarted', 'AutumnPumpkin', 5, 1, 100, 100, 0, 'Talk', 'Arthur', 'Ruined City', 'Arthur', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- MAP 3
    -- Q17
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""RewardItemId"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 3] The Ice Slimes', 'Meet Queen Roselyn Aurora and defeat 8 Ice Slimes.', 'Main', 'NotStarted', 'FrozenMountain', 6, 8, 300, 300, 0, (SELECT ""ItemId"" FROM ""Items"" WHERE ""Name"" = 'Magic Flour' LIMIT 1), 'Defeat', 'slime_ice', 'Snow Fields', 'Roselyn Aurora Queen', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q18
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 3] Magic Flour for the Priest', 'Deliver Magic Flour (obtained from the Queen) to the Priest (Zephyr).', 'Main', 'NotStarted', 'FrozenMountain', 6, 1, 150, 150, 0, 'Talk', 'Zephyr', 'Frozen Mountain', 'Roselyn Aurora Queen', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q20
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 3] The Forbidden Zone', 'Head to the forbidden zone and speak with Roland to explore it.', 'Main', 'NotStarted', 'FrozenMountain', 7, 1, 150, 150, 0, 'Explore', 'Roland', 'Forbidden Zone', 'Roland', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q21
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""BossMonsterId"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 3] Truth of the Codex', 'Discover the truth of the codex and defeat GolemBoss to get the Golem Seal Book.', 'Main', 'NotStarted', 'FrozenMountain', 8, 1, 800, 1500, 0, 'Defeat', 'GolemBoss', 'Forbidden Zone', 10, 'Roland', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q22
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 4] Skeleton Army', 'Defeat 12 skeletons in the valley for Valiant Warrior.', 'Main', 'NotStarted', 'AbandonedCastle', 9, 12, 500, 500, 0, 'Defeat', 'Skeleton', 'Valley', 'Valiant Warrior', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q23
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 4] The Abandoned Village', 'Go to Tide-Knell village, meet Natalie, and dig up the skull near the old well.', 'Main', 'NotStarted', 'AbandonedCastle', 9, 1, 300, 300, 0, 'Interact', 'Skull', 'Tide-Knell', 'Valiant Warrior', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    ...
    -- Q24
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""RewardItemId"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 4] Rest in Peace', 'Read Natalie''s suicide letter and bury her remains under the ivy tree. Receive Mystic Key.', 'Main', 'NotStarted', 'AbandonedCastle', 10, 1, 400, 400, 0, (SELECT ""ItemId"" FROM ""Items"" WHERE ""Name"" = 'Mystic Key' LIMIT 1), 'Talk', 'Natalie', 'Tide-Knell', 'Natalie', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q25
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 4] Deserted Island', 'Talk to Elf Guard on the deserted island and collect 5 Ancient Leaves.', 'Main', 'NotStarted', 'AbandonedCastle', 10, 5, 450, 450, 0, 'Collect', 'Ancient Leaves', 'Northern Plateau', 'Elf Guard', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q26
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""BossMonsterId"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 4] The UnderKing', 'Defeat the UnderKing to claim the final UnderKing Seal Book.', 'Main', 'NotStarted', 'AbandonedCastle', 11, 1, 2000, 3000, 0, 'Defeat', 'UnderKing', 'Deserted Island', 15, 'Elf Guard', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q27
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 4] Return to Elf Forest', 'Talk to Elf Guard. He will open a portal back to the Elf Forest.', 'Main', 'NotStarted', 'AbandonedCastle', 12, 1, 100, 100, 0, 'Talk', 'Elf Guard', 'Deserted Island', 'Elf Guard', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
    ...
    -- Q28
    INSERT INTO ""Quests"" (""Title"", ""Description"", ""Type"", ""DefaultStatus"", ""MapName"", ""RequiredLevel"", ""TargetAmount"", ""RewardExperience"", ""RewardGold"", ""RewardGems"", ""ObjectiveType"", ""ObjectiveTarget"", ""ObjectiveLocation"", ""QuestGiverName"", ""IsActive"")
    VALUES ('[Chapter 1] Save the Origin Tree', 'Talk to Lyra and use the 4 Seal Books to cleanse the tree. ""To be continued"".', 'Main', 'NotStarted', 'ElfForest', 12, 1, 5000, 5000, 0, 'Talk', 'Lyra', 'Origin Tree', 'Lyra', true) RETURNING ""QuestId"" INTO q_id;
    INSERT INTO ""NPCDialogues"" (""NPCId"", ""LinkedQuestId"", ""ResponseType"", ""Content"", ""DisplayOrder"", ""IsActive"")
    VALUES 
