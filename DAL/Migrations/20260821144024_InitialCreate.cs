    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "+2% Max HP", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Complete the first chapter", "pioneer", true, "Pioneer", 0, 1, 5, 100m, null, 1, "Progression" },
                    { 2, "+2% Attack", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Defeat 1,000 monsters", "monster_hunter", true, "Monster Hunter", 0, 1000, 25, 500m, null, 1, "Combat" },
                    { 3, "+2% Critical Rate", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Reach the required cumulative Critical Rate", "deadeye", true, "Deadeye", 0, 100, 15, 250m, null, 1, "Progression" },
                    { 4, "+3% Defense", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Die fewer than 10 times before Level 30", "unyielding", true, "The Unyielding", 0, 1, 40, 750m, null, 1, "Progression" },
                    { 5, "+3% Movement Speed", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Explore every region on the map", "swift_wanderer", true, "Swift Wanderer", 0, 1, 25, 500m, null, 1, "Exploration" },
                    { 6, "+5% Gold Gain", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Open 500 treasure chests", "treasure_seeker", true, "Treasure Seeker", 0, 500, 40, 750m, null, 1, "Collection" },
                    { 7, "+3% EXP Gain", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Complete 100 quests", "adventurer", true, "Adventurer", 0, 100, 50, 1000m, null, 1, "Progression" },
                    { 8, "+2% Max HP, +2% Defense", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Complete 100 co-op dungeons", "faithful_companion", true, "Faithful Companion", 0, 100, 50, 1000m, null, 1, "Social" },
                    { 9, "+3% Damage to Bosses", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Defeat every Boss at least once", "conqueror", true, "Conqueror", 0, 1, 75, 1500m, null, 1, "Combat" },
                    { 10, "+2% to All Stats (HP, ATK, DEF)", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Reach the maximum level and complete the main storyline", "legend_elarion", true, "Legend of Elarion", 0, 1, 125, 2500m, null, 1, "Progression" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { -27, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 27, true, null, null, 0, "EXP", 300m, null },
                    ...
                    { -23, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 23, true, null, null, 0, "EXP", 250m, null },
                    ...
                    { -17, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 17, true, null, null, 0, "EXP", 200m, null },
                    ...
                    { -11, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 11, true, null, null, 0, "EXP", 150m, null },
                    ...
                    { -6, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 6, true, null, null, 0, "EXP", 100m, null },
                    ...
                    { -2, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 2, true, null, null, 0, "EXP", 50m, null },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 4, new DateTime(2099, 12, 31, 23, 59, 59, 0, DateTimeKind.Utc), true, "Mythic & Legendary Arsenal Banner", 80, 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Weapon" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 31, 50m, 0.5f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Mystical flour imbued with purifying magic. Reduces your corruption by 50% when consumed.", null, true, 99, "Magic Flour", "Legendary", "None", "Consumable" },
                    ...
                    { 101, 5000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Legendary holy blade of the High Knight.", null, true, 1, "Excalibur of Light", "Mythic", "Weapon", "Weapon" },
                    { 102, 5000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Supreme Astral Staff imbued with cosmic magic.", null, true, 1, "Staff of the Cosmos", "Mythic", "Weapon", "Weapon" },
                    { 103, 5000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Mythical bow crafted from the World Tree's core.", null, true, 1, "Bow of Eternity", "Mythic", "Weapon", "Weapon" },
                    { 104, 4500m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Divine shield forged in solar fire.", null, true, 1, "Aegis of the Sun God", "Mythic", "Shield", "Armor" },
                    { 105, 4500m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Crown worn by ancient mythical emperors.", null, true, 1, "Crown of Divine Sovereign", "Mythic", "Helmet", "Armor" },
                    { 106, 4800m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Armor woven with celestial light.", null, true, 1, "Celestia Sacred Armor", "Mythic", "Armor", "Armor" },
                    { 107, 4200m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Cloak rendering the wearer untouchable.", null, true, 1, "Cloak of the Shadow Void", "Mythic", "Armor", "Armor" },
                    { 108, 4000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Ring harboring supreme elemental power.", null, true, 1, "Ring of Omnipotence", "Mythic", "Ring", "Armor" },
                    { 109, 4000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Necklace pulsing with immortal flame.", null, true, 1, "Heart of the Phoenix Necklace", "Mythic", "Necklace", "Armor" },
                    { 110, 4000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Ancient talisman granting endless mana stream.", null, true, 1, "Talisman of Infinite Mana", "Mythic", "Necklace", "Armor" },
                    { 111, 5000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Heavy hammer capable of shattering mountains.", null, true, 1, "Warhammer of Titan King", "Mythic", "Weapon", "Weapon" },
                    { 112, 5000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Tome containing forbidden destruction spells.", null, true, 1, "Grimoire of Celestial Ruin", "Mythic", "Weapon", "Weapon" },
                    { 113, 2500m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Heavy greatsword forged from dragon horns.", null, true, 1, "Valiant Dragon Greatsword", "Legendary", "Weapon", "Weapon" },
                    { 114, 2500m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Stave used by supreme archmages.", null, true, 1, "Archmage Astral Rod", "Legendary", "Weapon", "Weapon" },
                    { 115, 2500m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Greatbow infused with gale spirits.", null, true, 1, "Windrunner Grand Bow", "Legendary", "Weapon", "Weapon" },
                    { 116, 2200m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Heavy tower shield radiating holy aura.", null, true, 1, "Radiant Guardian Shield", "Legendary", "Shield", "Armor" },
                    { 117, 2000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Enchanted cloak shimmering with starlight.", null, true, 1, "Cloak of Stars", "Legendary", "Armor", "Armor" },
                    { 118, 2000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Amulet burning with unwavering courage.", null, true, 1, "Amulet of Eternal Flame", "Legendary", "Necklace", "Armor" },
                    { 119, 1000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Broadsword wielded by holy paladins.", null, true, 1, "Paladin Broadsword", "Epic", "Weapon", "Weapon" },
                    { 120, 1000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Grimoire mastering core elements.", null, true, 1, "Elemental Grimoire", "Epic", "Weapon", "Weapon" },
                    { 121, 1000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Crossbow firing silent deadly bolts.", null, true, 1, "Shadow Crossbow", "Epic", "Weapon", "Weapon" },
                    { 122, 900m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Sturdy steel shield protecting fortress walls.", null, true, 1, "Fortress Tower Shield", "Epic", "Shield", "Armor" },
                    { 123, 850m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Hood favored by master assassins.", null, true, 1, "Hood of Silent Night", "Epic", "Helmet", "Armor" },
                    { 124, 800m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Ring imbued with storm powers.", null, true, 1, "Ring of Tempest", "Epic", "Ring", "Armor" },
                    { 125, 450m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Long steel polearm for foot soldiers.", null, true, 1, "Steel Halberd", "Rare", "Weapon", "Weapon" },
                    { 126, 450m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Wand focusing magic crystal energy.", null, true, 1, "Crystal Wand", "Rare", "Weapon", "Weapon" },
                    { 127, 450m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Bow designed for swift distance attacks.", null, true, 1, "Recurve Composite Bow", "Rare", "Weapon", "Weapon" },
                    { 128, 400m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Standard shield carried by elite knights.", null, true, 1, "Knight Iron Shield", "Rare", "Shield", "Armor" },
                    { 129, 380m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Cloak woven from ranger silk.", null, true, 1, "Mantle of the Forest", "Rare", "Armor", "Armor" },
                    { 130, 350m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Necklace enhancing stamina.", null, true, 1, "Necklace of Vitality", "Rare", "Necklace", "Armor" },
                    { 131, 220m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Heavy axe used in close combat.", null, true, 1, "Battle Axe", "Uncommon", "Weapon", "Weapon" },
                    { 132, 220m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Simple wand for mage students.", null, true, 1, "Apprentice Rod", "Uncommon", "Weapon", "Weapon" },
                    { 133, 220m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Light crossbow easy to reload.", null, true, 1, "Light Crossbow", "Uncommon", "Weapon", "Weapon" },
                    { 134, 180m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Small wooden shield for parrying.", null, true, 1, "Wooden Buckler", "Uncommon", "Shield", "Armor" },
                    { 135, 150m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Simple ring granting minor defense.", null, true, 1, "Band of Minor Protection", "Uncommon", "Ring", "Armor" },
                    { 139, 60m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Simple cloth headwear.", null, true, 1, "Cloth Cap", "Common", "Helmet", "Armor" },
                    { 140, 60m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Worn cloak for long journeys.", null, true, 1, "Traveler Cloak", "Common", "Armor", "Armor" },
                    { 156, 1000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Heavy gauntlets increasing unwavering strike.", null, true, 1, "Gauntlets of Iron Will", "Epic", "Gloves", "Armor" },
                    { 157, 4800m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Solar-infused visor worn by high sun emperors.", null, true, 1, "Visor of the Sun Sovereign", "Mythic", "Helmet", "Armor" },
                    { 158, 2400m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Impenetrable steel helmet forged in dragon breath.", null, true, 1, "Helm of the Undying Knight", "Legendary", "Helmet", "Armor" },
                    { 159, 1000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Silken hood concealing the assassin in pitch darkness.", null, true, 1, "Cowl of the Phantom Assassin", "Epic", "Helmet", "Armor" },
                    { 160, 4500m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Mythical boots granting lightning swiftness and levitation.", null, true, 1, "Boots of Celestial Strider", "Mythic", "Boots", "Armor" },
                    { 161, 2200m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Heavy greaves carved from unbreakable glacier ice.", null, true, 1, "Treads of the Frost Vanguard", "Legendary", "Boots", "Armor" },
                    { 162, 1000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Light leather boots silencing every footstep in combat.", null, true, 1, "Shadowstep Striders", "Epic", "Boots", "Armor" },
                    { 163, 4500m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Titanium gauntlets crushing boulders with raw strike.", null, true, 1, "Gauntlets of Titan Strength", "Mythic", "Gloves", "Armor" },
                    { 164, 2200m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Razor-sharp gauntlets tipped with ancient dragon talons.", null, true, 1, "Vanguard Dragon Claws", "Legendary", "Gloves", "Armor" },
                    { 165, 1000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Enchanted gloves amplifying magical casting velocity.", null, true, 1, "Spellweaver Touch Gloves", "Epic", "Gloves", "Armor" },
                    { 166, 4500m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Astral necklace channeling the energy of distant galaxies.", null, true, 1, "Pendant of Cosmic Harmony", "Mythic", "Necklace", "Armor" },
                    { 167, 2200m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Ancient vampire necklace granting lifesteal aura.", null, true, 1, "Choker of the Bloodline", "Legendary", "Necklace", "Armor" },
                    { 168, 1000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Amulet absorbing hostile magical explosions.", null, true, 1, "Amulet of Arcane Shielding", "Epic", "Necklace", "Armor" },
                    { 169, 4500m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Ring granting supreme authority over all elemental magic.", null, true, 1, "Band of Absolute Dominion", "Mythic", "Ring", "Armor" },
                    { 170, 2200m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Blood-red ring boosting critical strikes under fury.", null, true, 1, "Ring of the Berserker Heart", "Legendary", "Ring", "Armor" },
                    { 171, 1000m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Graceful silver ring enhancing agility and dodge rate.", null, true, 1, "Signet of the Wind Walker", "Epic", "Ring", "Armor" },
                    { 172, 180m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Flexible leather trousers designed for long wilderness travels.", null, true, 1, "Traveler Leather Trousers", "Uncommon", "Pants", "Armor" },
                    { 173, 380m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Heavy reinforced iron leggings offering sturdy defense for frontline knights.", null, true, 1, "Ironclad Vanguard Greaves", "Rare", "Pants", "Armor" },
                    { 174, 2200m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Glacier-forged armored greaves emitting a chilling protective aura.", null, true, 1, "Greaves of the Frost Vanguard", "Legendary", "Pants", "Armor" },
                    { 175, 4500m, 0f, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Celestial-embroidered leggings granting divine mobility and defense.", null, true, 1, "Leggings of Celestial Strider", "Mythic", "Pants", "Armor" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { -28, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 28, true, null, 18, 1, "Item", 0m, null },
                    { -21, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 21, true, null, 17, 1, "Item", 0m, null },
                    { -14, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 14, true, null, 16, 1, "Item", 0m, null },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 101, 110, 0, 0, 45, 10, 45, 20, 15, 0, 0, 0, 101 },
                    { 102, 115, 0, 0, 50, 5, 50, 18, 18, 0, 0, 0, 102 },
                    { 103, 105, 0, 0, 42, 15, 40, 22, 12, 0, 0, 8, 103 },
                    { 104, 0, 70, 300, 0, 0, 0, 0, 0, 30, 120, 0, 104 },
                    { 105, 15, 45, 220, 5, 0, 20, 10, 0, 20, 80, 0, 105 },
                    { 106, 0, 85, 450, 0, 0, 0, 0, 0, 35, 180, 0, 106 },
                    { 107, 20, 40, 200, 10, 8, 25, 12, 5, 15, 80, 12, 107 },
                    { 108, 25, 20, 120, 10, 0, 30, 15, 8, 8, 50, 0, 108 },
                    { 109, 15, 25, 250, 5, 0, 20, 10, 5, 10, 100, 0, 109 },
                    { 110, 30, 15, 150, 12, 5, 25, 12, 10, 5, 60, 5, 110 },
                    { 111, 130, 15, 100, 55, 0, 50, 15, 20, 5, 40, -3, 111 },
                    { 112, 125, 10, 50, 50, 5, 55, 20, 22, 5, 20, 0, 112 },
                    { 113, 65, 0, 0, 25, 5, 30, 12, 8, 0, 0, 0, 113 },
                    { 114, 68, 0, 0, 28, 0, 35, 10, 10, 0, 0, 0, 114 },
                    { 115, 62, 0, 0, 22, 10, 25, 14, 6, 0, 0, 6, 115 },
                    { 116, 0, 45, 180, 0, 0, 0, 0, 0, 18, 70, 0, 116 },
                    { 117, 10, 25, 120, 5, 4, 15, 6, 3, 10, 40, 8, 117 },
                    { 118, 12, 15, 140, 6, 0, 18, 8, 4, 5, 50, 0, 118 },
                    { 119, 38, 0, 0, 15, 0, 20, 8, 4, 0, 0, 0, 119 },
                    { 120, 40, 0, 0, 16, 0, 22, 6, 5, 0, 0, 0, 120 },
                    { 121, 36, 0, 0, 14, 6, 18, 9, 3, 0, 0, 4, 121 },
                    { 122, 0, 28, 110, 0, 0, 0, 0, 0, 11, 40, 0, 122 },
                    { 123, 8, 16, 70, 4, 0, 15, 7, 0, 6, 25, 0, 123 },
                    { 124, 10, 10, 60, 5, 3, 12, 5, 3, 4, 20, 3, 124 },
                    { 125, 22, 0, 0, 8, 0, 12, 4, 2, 0, 0, 0, 125 },
                    { 126, 24, 0, 0, 9, 0, 14, 4, 2, 0, 0, 0, 126 },
                    { 127, 20, 0, 0, 7, 4, 10, 5, 1, 0, 0, 3, 127 },
                    { 128, 0, 16, 65, 0, 0, 0, 0, 0, 6, 25, 0, 128 },
                    { 129, 4, 12, 45, 2, 0, 8, 3, 0, 4, 15, 4, 129 },
                    { 130, 5, 6, 40, 2, 0, 6, 3, 1, 2, 15, 0, 130 },
                    { 131, 13, 0, 0, 5, 0, 8, 3, 0, 0, 0, 0, 131 },
                    { 132, 14, 0, 0, 5, 0, 10, 2, 0, 0, 0, 0, 132 },
                    { 133, 12, 0, 0, 4, 3, 6, 3, 0, 0, 0, 2, 133 },
                    { 134, 0, 9, 35, 0, 0, 0, 0, 0, 3, 12, 0, 134 },
                    { 135, 2, 4, 20, 1, 0, 4, 2, 0, 2, 8, 0, 135 },
                    { 139, 0, 3, 15, 0, 0, 0, 0, 0, 1, 5, 0, 139 },
                    { 140, 0, 4, 20, 0, 0, 0, 0, 0, 1, 8, 2, 140 },
                    { 156, 12, 12, 50, 6, 5, 10, 5, 3, 5, 20, 0, 156 },
                    { 157, 0, 52, 260, 0, 0, 24, 14, 0, 24, 100, 0, 157 },
                    { 158, 0, 35, 160, 0, 0, 15, 8, 0, 15, 60, 0, 158 },
                    { 159, 0, 20, 85, 0, 0, 14, 7, 0, 8, 30, 0, 159 },
                    { 160, 0, 40, 200, 0, 10, 0, 10, 0, 18, 80, 15, 160 },
                    { 161, 0, 28, 140, 0, 5, 0, 0, 0, 12, 50, 10, 161 },
                    { 162, 0, 16, 75, 0, 4, 0, 5, 0, 6, 25, 8, 162 },
                    { 163, 40, 35, 150, 18, 0, 0, 0, 12, 15, 60, 0, 163 },
                    { 164, 25, 22, 90, 12, 0, 18, 8, 0, 8, 35, 0, 164 },
                    { 165, 15, 12, 50, 8, 8, 12, 0, 0, 5, 20, 0, 165 },
                    { 166, 25, 30, 280, 10, 0, 25, 12, 0, 12, 120, 0, 166 },
                    { 167, 16, 18, 170, 8, 0, 16, 8, 0, 6, 60, 0, 167 },
                    { 168, 8, 12, 90, 4, 0, 10, 5, 0, 5, 35, 0, 168 },
                    { 169, 35, 25, 180, 15, 0, 30, 15, 10, 10, 70, 0, 169 },
                    { 170, 22, 14, 100, 10, 0, 22, 10, 6, 5, 40, 0, 170 },
                    { 171, 12, 8, 60, 5, 0, 12, 6, 0, 3, 20, 5, 171 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 0.05m, 1, true, 102 },
                    { 3, 0.05m, 1, true, 103 },
                    { 4, 0.025m, 1, false, 104 },
                    { 5, 0.025m, 1, false, 105 },
                    { 6, 0.025m, 1, false, 106 },
                    { 7, 0.025m, 1, false, 107 },
                    { 8, 0.025m, 1, false, 108 },
                    { 9, 0.025m, 1, false, 109 },
                    { 10, 0.025m, 1, false, 110 },
                    { 11, 0.025m, 1, false, 111 },
                    { 12, 0.025m, 1, false, 112 },
                    { 13, 0.025m, 1, false, 157 },
                    { 14, 0.025m, 1, false, 160 },
                    { 15, 0.025m, 1, false, 163 },
                    { 16, 0.025m, 1, false, 166 },
                    { 17, 0.025m, 1, false, 169 },
                    { 18, 0.22m, 1, false, 113 },
                    { 19, 0.22m, 1, false, 114 },
                    { 20, 0.22m, 1, false, 115 },
                    { 21, 0.24m, 1, false, 31 },
                    { 22, 0.22m, 1, false, 158 },
                    { 23, 0.22m, 1, false, 161 },
                    { 24, 0.22m, 1, false, 164 },
                    { 25, 0.22m, 1, false, 167 },
                    { 26, 0.22m, 1, false, 170 },
                    { 27, 0.70m, 1, false, 156 },
                    { 28, 0.70m, 1, false, 159 },
                    { 29, 0.70m, 1, false, 162 },
                    { 30, 0.70m, 1, false, 165 },
                    { 31, 0.70m, 1, false, 168 },
                    { 32, 0.70m, 1, false, 171 },
                    { 33, 0.80m, 1, false, 13 },
                    { 34, 1.85m, 1, false, 125 },
                    { 35, 1.85m, 1, false, 126 },
                    { 36, 1.85m, 1, false, 127 },
                    { 37, 1.85m, 1, false, 128 },
                    { 38, 1.85m, 1, false, 129 },
                    { 39, 1.85m, 1, false, 130 },
                    { 40, 1.95m, 1, false, 8 },
                    { 41, 1.95m, 1, false, 14 },
                    { 42, 2.75m, 1, false, 131 },
                    { 43, 2.75m, 1, false, 132 },
                    { 44, 2.75m, 1, false, 133 },
                    { 45, 2.75m, 1, false, 134 },
                    { 46, 2.75m, 1, false, 135 },
                    { 47, 2.85m, 1, false, 11 },
                    { 48, 2.85m, 1, false, 18 },
                    { 49, 2.775m, 1, false, 20 },
                    { 50, 2.775m, 1, false, 21 },
                    { 51, 2.50m, 1, false, 139 },
                    { 52, 2.50m, 1, false, 140 },
                    { 53, 2.50m, 1, false, 5 },
                    { 54, 2.50m, 1, false, 6 },
                    { 55, 2.50m, 1, false, 7 },
                    { 56, 2.50m, 1, false, 9 },
                    ...
                    { 64, 4.00m, 1, false, 4 },
                    { 65, 4.00m, 1, false, 22 },
                    { 66, 0.025m, 1, false, 175 },
                    { 67, 0.22m, 1, false, 174 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 16, null, null, "Gems", 0, true, 13, 130m, "Fixed", -1, 0 },
                    { 17, null, null, "Gems", 0, true, 8, 120m, "Fixed", -1, 0 },
                    { 18, null, null, "Gems", 0, true, 12, 400m, "Fixed", -1, 0 },
                    { 19, null, null, "Gems", 0, true, 4, 25m, "Fixed", -1, 0 },
                    { 20, null, null, "Gems", 3, true, 31, 500m, "DailyDeal", -1, 0 },
                    { 21, null, null, "Gems", 1, true, 116, 350m, "DailyDeal", -1, 0 },
                    { 22, null, null, "Gems", 1, true, 117, 300m, "DailyDeal", -1, 0 },
                    { 23, null, null, "Gems", 1, true, 118, 300m, "DailyDeal", -1, 0 },
                    { 24, null, null, "Gems", 2, true, 119, 150m, "DailyDeal", -1, 0 },
                    { 25, null, null, "Gems", 2, true, 120, 150m, "DailyDeal", -1, 0 },
                    { 26, null, null, "Gems", 2, true, 121, 150m, "DailyDeal", -1, 0 },
                    { 27, null, null, "Gems", 2, true, 124, 120m, "DailyDeal", -1, 0 },
                    { 28, null, null, "Gold", 5, true, 129, 420m, "DailyDeal", -1, 0 },
                    { 29, null, null, "Gems", 0, true, 122, 135m, "Fixed", -1, 0 },
                    { 30, null, null, "Gems", 0, true, 123, 125m, "Fixed", -1, 0 },
                    { 31, null, null, "Gold", 0, true, 125, 450m, "Fixed", -1, 0 },
                    { 32, null, null, "Gold", 0, true, 126, 450m, "Fixed", -1, 0 },
                    { 33, null, null, "Gold", 0, true, 127, 450m, "Fixed", -1, 0 },
                    { 34, null, null, "Gold", 0, true, 128, 400m, "Fixed", -1, 0 },
                    { 35, null, null, "Gold", 0, true, 130, 380m, "Fixed", -1, 0 },
                    { 36, null, null, "Gold", 0, true, 131, 220m, "Fixed", -1, 0 },
                    { 37, null, null, "Gold", 0, true, 132, 220m, "Fixed", -1, 0 },
                    { 38, null, null, "Gold", 0, true, 133, 220m, "Fixed", -1, 0 },
                    { 39, null, null, "Gold", 0, true, 134, 180m, "Fixed", -1, 0 },
                    { 40, null, null, "Gold", 0, true, 135, 150m, "Fixed", -1, 0 },
                    { 41, null, null, "Gold", 0, true, 139, 60m, "Fixed", -1, 0 },
                    { 42, null, null, "Gold", 0, true, 140, 60m, "Fixed", -1, 0 },
                    { 43, null, null, "Gold", 0, true, 172, 180m, "Fixed", -1, 0 },
                    { 44, null, null, "Gold", 0, true, 173, 380m, "Fixed", -1, 0 }
                });
