        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 28, null, "NotStarted", "The trail of the seals ends at a ruined castle where the dead still keep watch. The Valiant Warrior holds the valley alone — help him put down 12 skeletons.", true, "AbandonedCastle", "Valley", "Skeleton", "Defeat", "Valiant Warrior", null, 9, 300, 5m, 50m, null, null, 12, "[Chapter 4] Break the Skeleton Army", "Main" },
                    { 31, null, "NotStarted", "Natalie's key opens the way to a deserted island where one elf guard still stands his post. He needs 5 Ancient Leaves from the plateau to break the seal below.", true, "AbandonedCastle", "Northern Plateau", "Ancient Leaves", "Collect", "Elf Guard", null, 10, 250, 5m, 45m, null, null, 5, "[Chapter 4] Ancient Leaves of the Isle", "Main" },
                    { 33, null, "NotStarted", "All four seals are in your pack. Speak to the Elf Guard — he can open a portal back to the Elf Forest.", true, "AbandonedCastle", "Deserted Island", "Elf Guard", "Talk", "Elf Guard", null, 12, 150, 5m, 10m, null, null, 1, "[Chapter 4] Ask for the Way Home", "Main" },
                    { 34, null, "NotStarted", "You are home, and the Origin Tree is worse than you left it. Bring all four Seal Books to Lyra.", true, "ElfForest", "Origin Tree", "Lyra", "Talk", "Lyra", null, 12, 250, 5m, 50m, null, null, 1, "[Chapter 5] Return with the Seals", "Main" },
                    { 35, null, "NotStarted", "Lyra opens the rite and steps back — the seals must be set by the one who won them. Place the four Seal Books on the Origin Tree and break the curse.", true, "ElfForest", "Elf Forest", "Origin Tree", "Interact", "Lyra", null, 12, 400, 5m, 250m, null, null, 1, "[Chapter 5] Heal the Origin Tree", "Main" },
                    { 36, null, "NotStarted", "The Origin Tree is green again and the forest wakes around it. Speak with Lyra one last time — the codex had a master, and that story is not finished.", true, "ElfForest", "Origin Tree", "Lyra", "Talk", "Lyra", null, 12, 300, 5m, 200m, null, null, 1, "[Chapter 5] A New Dawn", "Main" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 67, "Back, stranger, keep your back to the rock! They come up out of the valley floor faster than I can cut them down.", 1, true, 28, null, 11, "None" },
                    { 68, "This is no ordinary haunting. An ancient power is leaking somewhere near, and the dead rise faster than they fall.", 2, true, 28, null, 11, "None" },
                    { 69, "Cut down 12 of them in the valley with me. Two blades may be enough where one was not.", 4, true, 28, null, 11, "Quest" },
                    { 70, "The animals are fleeing from the abandoned village of Tide-Knell. Look into it, and find the girl Natalie.", 5, true, 28, null, 11, "Reward" },
                    { 76, "An outsider, with a Mystic Key, standing on my island. The sea should have kept you. Yet here you are.", 1, true, 31, null, 13, "None" },
                    { 77, "I am the last guard of this place. I know what you carry, and I know the forest you are trying to reach.", 2, true, 31, null, 13, "None" },
                    { 78, "Collect 5 Ancient Leaves from the Northern Plateau. Bring them, and I will begin the rite of return.", 4, true, 31, null, 13, "Quest" },
                    { 82, "It is done. The UnderKing has fallen, and all four Seal Books are in one pair of hands for the first time in an age.", 1, true, 33, null, 13, "None" },
                    { 83, "You want the way home. I will give it, but understand what waits: the Origin Tree is nearly gone.", 2, true, 33, null, 13, "None" },
                    { 84, "Then go. The portal to the Elf Forest is open. Save the tree, outsider.", 4, true, 33, null, 13, "Reward" },
                    { 85, "You came back. Through the ruins, the snow, the ban, the sea — and you are carrying all four seals.", 1, true, 34, null, 2, "None" },
                    { 86, "Bring the four books to me here, at the roots. Hurry.", 4, true, 34, null, 2, "Quest" },
                    { 87, "The curse is breaking... The Origin Tree is finally healing!", 1, true, 36, null, 2, "None" },
                    { 88, "Thank you, truly. The Origin Tree is saved. But this is not the end... To be continued.", 4, true, 36, null, 2, "Reward" },
                    ...
                    { 90, "The tree has almost no strength left. Every leaf it drops, the curse takes a little more of the forest.", 2, true, 34, null, 2, "None" },
                    { 91, "The four seals are whole. I have opened the rite... but I cannot finish it.", 1, true, 35, null, 2, "None" },
                    { 92, "The seals answer only to the one who won them. It must be your hand, not mine.", 2, true, 35, null, 2, "None" },
                    { 93, "Step to the Origin Tree and set the four Seal Books upon it. Break the curse.", 4, true, 35, null, 2, "Quest" },
                    ...
                    { 116, "There is a Seal Book buried under all this bone. I have felt it since the day the leak began.", 3, true, 28, null, 11, "None" },
                    { 120, "A portal home cannot be forced. It must be grown, and for that the rite needs leaves older than the curse itself.", 3, true, 31, null, 13, "None" },
                    { 122, "The rite will open once and close behind you. Whatever you leave undone on this side stays undone.", 3, true, 33, null, 13, "None" },
                    { 123, "Four books, four elders, four bindings broken. Set them together and the curse has nowhere left to hide.", 3, true, 34, null, 2, "None" },
                    { 124, "I am the tree's spirit. If the curse takes the roots, it takes me with them — so do not hesitate at the last step.", 3, true, 35, null, 2, "None" },
                    { 125, "Look at the roots. Green, after all this time. The forest will remember the one who stood here today.", 2, true, 36, null, 2, "None" },
                    { 126, "And yet the cloaked one was never found, and no one has said who broke the four bindings in the first place.", 3, true, 36, null, 2, "None" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 26, 10, "NotStarted", "Two ancient things wait inside the ban: a giant of stone, and the spirit that never leaves his side. Defeat them both and take the Golem Seal Book.", true, "FrozenMountain", "Forbidden Zone", "Golem Boss", "Defeat", "Roland", null, 8, 400, 5m, 150m, null, null, 2, "[Chapter 3] The Sealed Guardians", "Main" },
                    { 29, null, "NotStarted", "In the drowned village of Tide-Knell a girl named Natalie asks a strange favour: dig beside the old well and lift out the skull buried there.", true, "AbandonedCastle", "Tide-Knell", "Skull", "Interact", "Natalie", null, 9, 200, 5m, 30m, 32, null, 1, "[Chapter 4] The Skull by the Well", "Main" },
                    { 30, null, "NotStarted", "The skull is hers. Read the letter she left behind, bury her remains beneath the ivy tree, and she will give you the key she died holding.", true, "AbandonedCastle", "Tide-Knell", "Ivy Tree", "Interact", "Natalie", null, 10, 200, 5m, 40m, 33, null, 1, "[Chapter 4] Lay Natalie to Rest", "Main" },
                    { 32, 15, "NotStarted", "The leaves burn away the ward and the crypt opens. The UnderKing holds the last two Seal Books — take them from him.", true, "AbandonedCastle", "Deserted Island", "UnderKing", "Defeat", "Elf Guard", null, 11, 500, 5m, 300m, null, null, 1, "[Chapter 4] Defeat the UnderKing", "Main" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 71, "You can see me. Nobody has seen me in a very long time. My name is Natalie, and this village is Tide-Knell.", 1, true, 29, null, 12, "None" },
                    { 72, "Please. Dig beside the old well and lift out the skull you find there. I am ready to be found.", 4, true, 29, null, 12, "Quest" },
                    { 73, "(A weathered letter lies where Natalie once stood. It is her own hand, and it is a farewell.)", 1, true, 30, null, 12, "None" },
                    { 74, "Thank you for bringing my remains home. Please bury me under the ivy tree in my courtyard, where I used to sit.", 3, true, 30, null, 12, "None" },
                    { 75, "The ancient power leak was my doing, and I have paid for it here. Take this Mystic Key — it opens the castle gates on the deserted island.", 4, true, 30, null, 12, "Quest" },
                    { 79, "The leaves are enough. The rite is ready. And yet I cannot light it — something below the castle is smothering it.", 1, true, 32, null, 13, "None" },
                    { 80, "The UnderKing has woken. He held the last Seal Book in his hands long before you were born.", 2, true, 32, null, 13, "None" },
                    { 81, "End his reign. Defeat the UnderKing and take the fourth book from him.", 4, true, 32, null, 13, "Quest" },
                    ...
                    { 117, "I cannot leave the well. I have tried. Something of me is still down in that ground, and it holds me here.", 2, true, 29, null, 12, "None" },
                    { 118, "The animals knew before you did. That is why they ran. They will not drink from a well with a girl in it.", 3, true, 29, null, 12, "None" },
                    { 119, "(She writes of a book she opened as a child, of a seal she did not understand, and of the day the valley began to fill with bone.)", 2, true, 30, null, 12, "None" },
                    { 121, "Three seals you have already. Without his, the Origin Tree cannot be cleansed and the forest ends with the tree.", 3, true, 32, null, 13, "None" },
