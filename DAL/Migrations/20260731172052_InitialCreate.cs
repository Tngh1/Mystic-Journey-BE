        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 17, null, "NotStarted", "Two trials done. The third lies south of the ruins, where goblin spear and axe bands have dug in. Break 3 of them.", true, "AutumnPumpkin", "Goblin Grounds", "Goblin", "Defeat", "Arthur", null, 4, 250, 5m, 25m, null, null, 10, "[Chapter 2] Trial III: The Goblin Grounds", "Main" },
                    ...
                    { 42, null, "NotStarted", "Set the four Seal Books on the Origin Tree and break the curse.", true, "ElfForest", "Elf Forest", "Origin Tree", "Interact", "Lyra", null, 12, 400, 5m, 250m, null, null, 1, "[Chapter 5] Heal the Origin Tree", "Main" },
                    { 43, null, "NotStarted", "The Origin Tree is green again. Speak with Lyra one last time.", true, "ElfForest", "Origin Tree", "Lyra", "Talk", "Lyra", null, 12, 300, 5m, 200m, null, null, 1, "[Chapter 5] A New Dawn", "Main" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 85, "You came back carrying all four seals. Bring them to the roots.", 1, true, 41, null, 2, "Quest" },
                    { 87, "The curse is breaking. The Origin Tree is finally healing. Thank you.", 1, true, 43, null, 2, "Reward" },
                    ...
                    { 91, "Set the four Seal Books upon the Origin Tree and break the curse.", 1, true, 42, null, 2, "Quest" },
