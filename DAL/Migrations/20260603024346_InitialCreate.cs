        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contents_Accounts_CreatedByAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameSettings_Accounts_CreatedByAccountId",
                        column: x => x.CreatedByAccountId,
                        principalTable: "Accounts",
                        principalColumn: "AccountId");
                    table.ForeignKey(
                        name: "FK_GameSettings_Accounts_UpdatedByAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DungeonRunMemberId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DungeonRunId = table.Column<int>(type: "integer", nullable: false),
                    PlayerProfileId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contents_CreatedByAccountId",
                table: "Contents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameSettings_CreatedByAccountId",
                table: "GameSettings",
                column: "CreatedByAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_GameSettings_UpdatedByAccountId",
                table: "GameSettings",
