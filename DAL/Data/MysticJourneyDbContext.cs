    ...
    public class MysticJourneyDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Quest>().HasData(
                ...
                new Quest { QuestId = 29, Title = "[Chapter 1] Return with the Seals",       Description = "Talk to Lyra about the 4 Seal Books.",                                                                                                              Type = "Main", DefaultStatus = "NotStarted", MapName = "ElfForest",      RequiredLevel = 12, TargetAmount = 1,  RewardExperience = 50,   RewardGold = 50m,   RewardGems = 5m, ObjectiveType = "Talk",      ObjectiveTarget = "Lyra",           ObjectiveLocation = "Origin Tree",      QuestGiverName = "Lyra",                 IsActive = true },
                new Quest { QuestId = 30, Title = "[Chapter 1] Heal the Origin Tree",        Description = "Use the 4 Seal Books on the Origin Tree.",                                                                                                          Type = "Main", DefaultStatus = "NotStarted", MapName = "ElfForest",      RequiredLevel = 12, TargetAmount = 1,  RewardExperience = 250,  RewardGold = 250m,  RewardGems = 5m, ObjectiveType = "Interact",  ObjectiveTarget = "Origin Tree",    ObjectiveLocation = "Elf Forest",       QuestGiverName = "Lyra",                 IsActive = true },
                new Quest { QuestId = 31, Title = "[Chapter 1] A New Dawn",                  Description = "Talk to Lyra. The Origin Tree is saved. To be continued...",                                                                                        Type = "Main", DefaultStatus = "NotStarted", MapName = "ElfForest",      RequiredLevel = 12, TargetAmount = 1,  RewardExperience = 200,  RewardGold = 200m,  RewardGems = 5m, ObjectiveType = "Talk",      ObjectiveTarget = "Lyra",           ObjectiveLocation = "Origin Tree",      QuestGiverName = "Lyra",                 IsActive = true }
            );
            ...
            modelBuilder.Entity<NPCDialogue>().HasData(
                ...
                new NPCDialogue { NPCDialogueId = 70, NPCId = 11, LinkedQuestId = 23, ResponseType = "Reward", Content = "The animals are fleeing from the abandoned village Tide-Knell. Investigate it and find Natalie.",              DisplayOrder = 4, IsActive = true },
                ...
                new NPCDialogue { NPCDialogueId = 73, NPCId = 12, LinkedQuestId = 25, ResponseType = "None",  Content = "(A weathered suicide letter lies where Natalie once stood...)",                                            DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 74, NPCId = 12, LinkedQuestId = 25, ResponseType = "None",  Content = "Thank you for bringing my remains back to my homeland. Please bury me under the ivy tree in my courtyard.",                                             DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 75, NPCId = 12, LinkedQuestId = 25, ResponseType = "Quest", Content = "The ancient power leak was my doing. I am deeply sorry. Take this Mystic Key. It will unlock the gates to the castle on the deserted island.",                                       DisplayOrder = 3, IsActive = true },
                ...
                new NPCDialogue { NPCDialogueId = 86, NPCId = 2, LinkedQuestId = 29, ResponseType = "Quest",  Content = "Please, hurry! Use the books on the Origin Tree to cleanse the corruption.",                                     DisplayOrder = 2, IsActive = true },
                ...
                new NPCDialogue { NPCDialogueId = 88, NPCId = 2, LinkedQuestId = 31, ResponseType = "Reward", Content = "Thank you! The Origin Tree is saved. But this is not the end... To be continued.",                               DisplayOrder = 2, IsActive = true }
            );
        }
    }
}
