...
public DbSet<DailyLoginReward> DailyLoginRewards => Set<DailyLoginReward>();
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<NPC>().HasData(
                new NPC { NPCId = 1,  Name = "Elder Rowan",           Description = "The wise guide of the Elf Forest.",              Type = "QuestGiver", MapName = "ElfForest",      PositionX = -0.7922616,    PositionY = 18.58149,    InteractionRadius = 2.5f, IsActive = true },
                new NPC { NPCId = 2,  Name = "Lyra",                  Description = "A spirit of the forest.",                        Type = "QuestGiver", MapName = "ElfForest",      PositionX = 30.01917,   PositionY = -6.100652,   InteractionRadius = 2.5f, IsActive = true },
                new NPC { NPCId = 3,  Name = "Mysterious Figure",     Description = "A mysterious figure in a cloak.",               Type = "QuestGiver", MapName = "ElfForest",      PositionX = 14.14317,   PositionY = -47.53569,   InteractionRadius = 2.5f, IsActive = true },
                new NPC { NPCId = 4,  Name = "Drake", Description = "The wise guide, now in the pumpkin town.",      Type = "QuestGiver", MapName = "AutumnPumpkin",  PositionX = -106.614,   PositionY = -42.76188,    InteractionRadius = 2.5f, IsActive = true },
                new NPC { NPCId = 5,  Name = "Tristan",               Description = "The city gate guard.",                          Type = "QuestGiver", MapName = "AutumnPumpkin",  PositionX = -97.12672,   PositionY = 21.72193,   InteractionRadius = 2.5f, IsActive = true },
                new NPC { NPCId = 6,  Name = "Arthur",                Description = "The silver knight.",                            Type = "QuestGiver", MapName = "AutumnPumpkin",  PositionX = -31.78855,   PositionY = 59.07007,   InteractionRadius = 2.5f, IsActive = true },
                new NPC { NPCId = 7,  Name = "Fa",                    Description = "A farmer collecting enchanted pumpkins.",       Type = "QuestGiver", MapName = "AutumnPumpkin",  PositionX = -101.7589,       PositionY = -26.23408,      InteractionRadius = 2.5f, IsActive = true },
            ...
            modelBuilder.Entity<Quest>().HasData(
                ...
                new Quest { QuestId = 16, Title = "[Chapter 2] Trial I: The Robber Camp",      Description = "Arthur will not send you at a dragon on faith. He sets four trials, and the first is the robbers holding the eastern camp. Cut down 8 of them.",                       Type = "Main", DefaultStatus = "NotStarted", MapName = "AutumnPumpkin",  RequiredLevel = 4,  TargetAmount = 8, RewardExperience = 250,  RewardGold = 25m,   RewardGems = 5m, ObjectiveType = "Defeat",     ObjectiveTarget = "RobberAssassin/RobberArcher", ObjectiveLocation = "Robber Camp", QuestGiverName = "Arthur", IsActive = true },
                new Quest { QuestId = 17, Title = "[Chapter 2] Trial II: The Haunted Quarter", Description = "One trial stands to your name. The second is the haunted quarter - ghosts, necromancers, and the red guard who died at their posts. Put down 10.",                     Type = "Main", DefaultStatus = "NotStarted", MapName = "AutumnPumpkin",  RequiredLevel = 4,  TargetAmount = 10, RewardExperience = 300,  RewardGold = 30m,   RewardGems = 5m, ObjectiveType = "Defeat",     ObjectiveTarget = "Ghost/NecromancerCast/RedGuard", ObjectiveLocation = "Haunted Quarter", QuestGiverName = "Arthur", IsActive = true },
                new Quest { QuestId = 18, Title = "[Chapter 2] Trial III: The Goblin Grounds", Description = "Two trials done. The third lies south of the ruins, where goblin spear and axe bands have dug in. Break 8 of them.",                                                   Type = "Main", DefaultStatus = "NotStarted", MapName = "AutumnPumpkin",  RequiredLevel = 4,  TargetAmount = 8, RewardExperience = 250,  RewardGold = 25m,   RewardGems = 5m, ObjectiveType = "Defeat",     ObjectiveTarget = "GoblinSpear/GoblinWarrior", ObjectiveLocation = "Goblin Grounds", QuestGiverName = "Arthur", IsActive = true },
                new Quest { QuestId = 19, Title = "[Chapter 2] Trial IV: The Goblin Warlord",  Description = "The goblins you broke were only a warband, and every warband answers to someone. Their warlord still holds the Goblin Grounds. Kill him and the last trial is yours.", Type = "Main", DefaultStatus = "NotStarted", MapName = "AutumnPumpkin",  RequiredLevel = 4,  TargetAmount = 1, RewardExperience = 350,  RewardGold = 40m,   RewardGems = 5m, ObjectiveType = "Defeat",     ObjectiveTarget = "GoblinWarlord", ObjectiveLocation = "Goblin Grounds", QuestGiverName = "Arthur", IsActive = true },
                new Quest { QuestId = 20, Title = "[Chapter 2] Slay the Dragon",              Description = "Arthur admits you now fight as well as he once did — and tells you what truly broke the city. A dragon nests in the ruins. End it.",                                                 Type = "Main", DefaultStatus = "NotStarted", MapName = "AutumnPumpkin",  RequiredLevel = 5,  TargetAmount = 1,  RewardExperience = 350,  RewardGold = 100m,  RewardGems = 5m, ObjectiveType = "Defeat",     ObjectiveTarget = "DragonBossIdle", ObjectiveLocation = "Ruined City",      QuestGiverName = "Arthur",               IsActive = true, BossMonsterId = 7 },
                new Quest { QuestId = 21, Title = "[Chapter 2] Arthur's Parting Words",       Description = "Return to Arthur for the knight's thanks and ask where the cursed codex came from. He points north, to a kingdom the codex froze solid.",                                            Type = "Main", DefaultStatus = "NotStarted", MapName = "AutumnPumpkin",  RequiredLevel = 5,  TargetAmount = 1,  RewardExperience = 150,  RewardGold = 10m,   RewardGems = 5m, ObjectiveType = "Talk",       ObjectiveTarget = "Arthur",         ObjectiveLocation = "Ruined City",      QuestGiverName = "Arthur",               IsActive = true },
                // ── MAP 3: Frozen Mountain ───────────────────────────────────────────
                new Quest { QuestId = 22, Title = "[Chapter 3] Slimes of the Snow Fields",    Description = "Queen Roselyn Aurora receives you in a hall of ice. Her fields are overrun before the winter stores are in — defeat 8 ice slimes for her.",                                        Type = "Main", DefaultStatus = "NotStarted", MapName = "FrozenMountain", RequiredLevel = 6,  TargetAmount = 8,  RewardExperience = 200,  RewardGold = 30m,   RewardGems = 5m, ObjectiveType = "Defeat",     ObjectiveTarget = "slime_ice",      ObjectiveLocation = "Snow Fields",      QuestGiverName = "Roselyn Aurora Queen", IsActive = true, RewardItemId = 31 },
                new Quest { QuestId = 23, Title = "[Chapter 3] Deliver the Magic Flour",      Description = "The Queen entrusts you with Magic Flour for the mountain shrine. Carry it up to the priest Zephyr before the pass closes.",                                                          Type = "Main", DefaultStatus = "NotStarted", MapName = "FrozenMountain", RequiredLevel = 6,  TargetAmount = 1,  RewardExperience = 150,  RewardGold = 15m,   RewardGems = 5m, ObjectiveType = "Talk",       ObjectiveTarget = "Zephyr",         ObjectiveLocation = "Frozen Mountain",  QuestGiverName = "Roselyn Aurora Queen", IsActive = true },
                new Quest { QuestId = 24, Title = "[Chapter 3] Dragons of the Frozen Peak",   Description = "Zephyr cannot hold his rites while ice dragons circle the shrine. Climb the peak and bring down 5 of them.",                                                                        Type = "Main", DefaultStatus = "NotStarted", MapName = "FrozenMountain", RequiredLevel = 7,  TargetAmount = 5,  RewardExperience = 250,  RewardGold = 40m,   RewardGems = 5m, ObjectiveType = "Defeat",     ObjectiveTarget = "Ice_Dragon",     ObjectiveLocation = "Frozen Mountain",  QuestGiverName = "Zephyr",               IsActive = true },
                new Quest { QuestId = 25, Title = "[Chapter 3] The Warden of the Ban",        Description = "Zephyr says the codex's mark lies inside the forbidden zone, and only its warden may open the way. Find Roland at the boundary stones and ask for passage.",                          Type = "Main", DefaultStatus = "NotStarted", MapName = "FrozenMountain", RequiredLevel = 7,  TargetAmount = 1,  RewardExperience = 150,  RewardGold = 15m,   RewardGems = 5m, ObjectiveType = "Talk",       ObjectiveTarget = "Roland",         ObjectiveLocation = "Forbidden Zone",   QuestGiverName = "Roland",               IsActive = true },
                new Quest { QuestId = 26, Title = "[Chapter 3] Break the Stone Guardian",     Description = "Roland tells you what the kingdom buried here: the codex itself, and the golem forged to guard it. Destroy the golem and take the second Seal Book.",                                 Type = "Main", DefaultStatus = "NotStarted", MapName = "FrozenMountain", RequiredLevel = 8,  TargetAmount = 1,  RewardExperience = 400,  RewardGold = 150m,  RewardGems = 5m, ObjectiveType = "Defeat",     ObjectiveTarget = "GolemBoss",      ObjectiveLocation = "Forbidden Zone",   QuestGiverName = "Roland",               IsActive = true, BossMonsterId = 10 },
                // ── MAP 4: Abandoned Castle ──────────────────────────────────────────
                new Quest { QuestId = 27, Title = "[Chapter 4] Break the Skeleton Army",      Description = "The trail of the seals ends at a ruined castle where the dead still keep watch. The Valiant Warrior holds the valley alone — help him put down 12 skeletons.",                       Type = "Main", DefaultStatus = "NotStarted", MapName = "AbandonedCastle",RequiredLevel = 9,  TargetAmount = 12, RewardExperience = 300,  RewardGold = 50m,   RewardGems = 5m, ObjectiveType = "Defeat",     ObjectiveTarget = "Skeleton",       ObjectiveLocation = "Valley",           QuestGiverName = "Valiant Warrior",      IsActive = true },
                new Quest { QuestId = 28, Title = "[Chapter 4] The Skull by the Well",        Description = "In the drowned village of Tide-Knell a girl named Natalie asks a strange favour: dig beside the old well and lift out the skull buried there.",                                     Type = "Main", DefaultStatus = "NotStarted", MapName = "AbandonedCastle",RequiredLevel = 9,  TargetAmount = 1,  RewardExperience = 200,  RewardGold = 30m,   RewardGems = 5m, ObjectiveType = "Interact",   ObjectiveTarget = "Skull",          ObjectiveLocation = "Tide-Knell",       QuestGiverName = "Natalie",              IsActive = true, RewardItemId = 32 },
                new Quest { QuestId = 29, Title = "[Chapter 4] Lay Natalie to Rest",          Description = "The skull is hers. Read the letter she left behind, bury her remains beneath the ivy tree, and she will give you the key she died holding.",                                        Type = "Main", DefaultStatus = "NotStarted", MapName = "AbandonedCastle",RequiredLevel = 10, TargetAmount = 1,  RewardExperience = 200,  RewardGold = 40m,   RewardGems = 5m, ObjectiveType = "Interact",   ObjectiveTarget = "Ivy Tree",       ObjectiveLocation = "Tide-Knell",       QuestGiverName = "Natalie",              IsActive = true, RewardItemId = 33 },
                new Quest { QuestId = 30, Title = "[Chapter 4] Ancient Leaves of the Isle",   Description = "Natalie's key opens the way to a deserted island where one elf guard still stands his post. He needs 5 Ancient Leaves from the plateau to break the seal below.",                   Type = "Main", DefaultStatus = "NotStarted", MapName = "AbandonedCastle",RequiredLevel = 10, TargetAmount = 5,  RewardExperience = 250,  RewardGold = 45m,   RewardGems = 5m, ObjectiveType = "Collect",    ObjectiveTarget = "Ancient Leaves", ObjectiveLocation = "Northern Plateau", QuestGiverName = "Elf Guard",            IsActive = true },
                new Quest { QuestId = 31, Title = "[Chapter 4] Defeat the UnderKing",         Description = "The leaves burn away the ward and the crypt opens. The UnderKing holds the last two Seal Books — take them from him.",                                                             Type = "Main", DefaultStatus = "NotStarted", MapName = "AbandonedCastle",RequiredLevel = 11, TargetAmount = 1,  RewardExperience = 500,  RewardGold = 300m,  RewardGems = 5m, ObjectiveType = "Defeat",     ObjectiveTarget = "UnderKing",      ObjectiveLocation = "Deserted Island",  QuestGiverName = "Elf Guard",            IsActive = true, BossMonsterId = 15 },
                new Quest { QuestId = 32, Title = "[Chapter 4] Ask for the Way Home",         Description = "All four seals are in your pack. Speak to the Elf Guard — he can open a portal back to the Elf Forest.",                                                                            Type = "Main", DefaultStatus = "NotStarted", MapName = "AbandonedCastle",RequiredLevel = 12, TargetAmount = 1,  RewardExperience = 150,  RewardGold = 10m,   RewardGems = 5m, ObjectiveType = "Talk",       ObjectiveTarget = "Elf Guard",      ObjectiveLocation = "Deserted Island",  QuestGiverName = "Elf Guard",            IsActive = true },
                // ── FINALE: back to the Elf Forest ───────────────────────────────────
                new Quest { QuestId = 33, Title = "[Chapter 5] Return with the Seals",        Description = "You are home, and the Origin Tree is worse than you left it. Bring all four Seal Books to Lyra.",                                                                                  Type = "Main", DefaultStatus = "NotStarted", MapName = "ElfForest",      RequiredLevel = 12, TargetAmount = 1,  RewardExperience = 250,  RewardGold = 50m,   RewardGems = 5m, ObjectiveType = "Talk",       ObjectiveTarget = "Lyra",           ObjectiveLocation = "Origin Tree",      QuestGiverName = "Lyra",                 IsActive = true },
                new Quest { QuestId = 34, Title = "[Chapter 5] Heal the Origin Tree",         Description = "Lyra opens the rite and steps back — the seals must be set by the one who won them. Place the four Seal Books on the Origin Tree and break the curse.",                             Type = "Main", DefaultStatus = "NotStarted", MapName = "ElfForest",      RequiredLevel = 12, TargetAmount = 1,  RewardExperience = 400,  RewardGold = 250m,  RewardGems = 5m, ObjectiveType = "Interact",   ObjectiveTarget = "Origin Tree",    ObjectiveLocation = "Elf Forest",       QuestGiverName = "Lyra",                 IsActive = true },
                new Quest { QuestId = 35, Title = "[Chapter 5] A New Dawn",                   Description = "The Origin Tree is green again and the forest wakes around it. Speak with Lyra one last time — the codex had a master, and that story is not finished.",                            Type = "Main", DefaultStatus = "NotStarted", MapName = "ElfForest",      RequiredLevel = 12, TargetAmount = 1,  RewardExperience = 300,  RewardGold = 200m,  RewardGems = 5m, ObjectiveType = "Talk",       ObjectiveTarget = "Lyra",           ObjectiveLocation = "Origin Tree",      QuestGiverName = "Lyra",                 IsActive = true }
            );
            ...
            modelBuilder.Entity<NPCDialogue>().HasData(
                ...
                // -- Q16: Trial I: The Robber Camp (QuestId=16, NPCId=6=Arthur) --
                new NPCDialogue { NPCDialogueId = 136, NPCId = 6, LinkedQuestId = 16, ResponseType = "None", Content = "The streets are quieter. But quiet is not the same as ready, and a dragon is not a ghoul in an alley.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 137, NPCId = 6, LinkedQuestId = 16, ResponseType = "None", Content = "I fought one once believing I was ready. You have seen what is left of me. So you will earn it in four trials.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 138, NPCId = 6, LinkedQuestId = 16, ResponseType = "None", Content = "The robbers took the eastern camp the night the city fell. They prey on whoever still crawls out of here alive.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 139, NPCId = 6, LinkedQuestId = 16, ResponseType = "Quest", Content = "Clear 8 of them from the Robber Camp. That is the first trial. Go.", DisplayOrder = 4, IsActive = true },
                // -- Q17: Trial II: The Haunted Quarter (QuestId=17, NPCId=6=Arthur) --
                new NPCDialogue { NPCDialogueId = 140, NPCId = 6, LinkedQuestId = 17, ResponseType = "None", Content = "One trial down, and you came back on your own feet again. Good.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 141, NPCId = 6, LinkedQuestId = 17, ResponseType = "None", Content = "The second is the haunted quarter - ghosts, necromancers, and the red guard. My own men, still standing their posts, still dead.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 142, NPCId = 6, LinkedQuestId = 17, ResponseType = "None", Content = "I could never walk that street again. A dragon will not care how brave you felt in daylight.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 143, NPCId = 6, LinkedQuestId = 17, ResponseType = "Quest", Content = "Put down 10 in the Haunted Quarter. Second trial. Move.", DisplayOrder = 4, IsActive = true },
                // -- Q18: Trial III: The Goblin Grounds (QuestId=18, NPCId=6=Arthur) --
                new NPCDialogue { NPCDialogueId = 144, NPCId = 6, LinkedQuestId = 18, ResponseType = "None", Content = "Two trials, two returns. I am beginning to believe the city might keep you.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 145, NPCId = 6, LinkedQuestId = 18, ResponseType = "None", Content = "The third is the ground south of the ruins. Goblins hold it, spear and axe together, and they fight as a pack.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 146, NPCId = 6, LinkedQuestId = 18, ResponseType = "None", Content = "A dragon will not come at you alone either. Learn to hold when more than one thing wants you dead.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 147, NPCId = 6, LinkedQuestId = 18, ResponseType = "Quest", Content = "Break 8 of them in the Goblin Grounds. Third trial.", DisplayOrder = 4, IsActive = true },
                // -- Q19: Trial IV: The Goblin Warlord (QuestId=19, NPCId=6=Arthur) --
                new NPCDialogue { NPCDialogueId = 148, NPCId = 6, LinkedQuestId = 19, ResponseType = "None", Content = "Three trials done. You have fought packs, and ghosts, and men. One thing is left that you have not fought.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 149, NPCId = 6, LinkedQuestId = 19, ResponseType = "None", Content = "The warband you broke answers to a warlord, and he is still down there holding what is left of them.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 150, NPCId = 6, LinkedQuestId = 19, ResponseType = "None", Content = "One enemy, bigger than you, who does not retreat and does not tire. That is the shape of a dragon fight. Learn it here where I can still pull you out.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 151, NPCId = 6, LinkedQuestId = 19, ResponseType = "Quest", Content = "Kill the Goblin Warlord. Finish the last trial and I will tell you everything.", DisplayOrder = 4, IsActive = true },
                // ── Q20: Slay the Dragon (QuestId=20, NPCId=6=Arthur) ──
                new NPCDialogue { NPCDialogueId = 46, NPCId = 6, LinkedQuestId = 20, ResponseType = "None", Content = "You came back quieter than you left. That is how I know the fighting took hold in you.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 47, NPCId = 6, LinkedQuestId = 20, ResponseType = "None", Content = "Then hear the rest of it. The monsters were never the cause. Something older nests above the ruins.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 109, NPCId = 6, LinkedQuestId = 20, ResponseType = "None", Content = "A dragon. It is the thing that broke this city, and the thing that broke me. I have carried that shame for years.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 48, NPCId = 6, LinkedQuestId = 20, ResponseType = "Quest", Content = "Finish what I could not. Climb to its nest and slay the dragon!", DisplayOrder = 4, IsActive = true },
                // ── Q21: Arthur's Parting Words (QuestId=21, NPCId=6=Arthur) ──
                new NPCDialogue { NPCDialogueId = 49, NPCId = 6, LinkedQuestId = 21, ResponseType = "None", Content = "The dragon is dead. I felt it go — the whole city breathed out at once. Thank you.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 50, NPCId = 6, LinkedQuestId = 21, ResponseType = "None", Content = "You want to know about the cloaked one. Yes. He passed through here before the dragon ever came.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 110, NPCId = 6, LinkedQuestId = 21, ResponseType = "None", Content = "He carries something that should have stayed sealed. Wherever he walks, the land sickens behind him.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 51, NPCId = 6, LinkedQuestId = 21, ResponseType = "Quest", Content = "He went north, into the frozen lands. Follow him to the Frozen Mountains. I will hold this city.", DisplayOrder = 4, IsActive = true },
                // ── Q22: Slimes of the Snow Fields (QuestId=22, NPCId=8=Roselyn Aurora Queen) ──
                new NPCDialogue { NPCDialogueId = 52, NPCId = 8, LinkedQuestId = 22, ResponseType = "None", Content = "A living stranger, walking in out of the snow. I am Roselyn Aurora, and what is left of this kingdom is mine to hold.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 53, NPCId = 8, LinkedQuestId = 22, ResponseType = "None", Content = "The codex passed over these fields and the cold turned wrong. My soldiers are gone. Only volunteers stand the walls now.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 111, NPCId = 8, LinkedQuestId = 22, ResponseType = "None", Content = "The slimes come closer each night. They freeze whatever they touch, and my people cannot reach the grain stores.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 54, NPCId = 8, LinkedQuestId = 22, ResponseType = "Quest", Content = "Clear 8 ice slimes from the Snow Fields. I would ask a knight, but I have none left to ask.", DisplayOrder = 4, IsActive = true },
                // ── Q23: Deliver the Magic Flour (QuestId=23, NPCId=8=Queen + NPCId=9=Zephyr) ──
                new NPCDialogue { NPCDialogueId = 55, NPCId = 8, LinkedQuestId = 23, ResponseType = "None", Content = "The fields are quiet tonight. My people walked to the grain stores without an escort for the first time in a month.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 56, NPCId = 8, LinkedQuestId = 23, ResponseType = "None", Content = "Now the harder trouble. Priest Zephyr keeps a rite burning at the peak — it is the only thing holding the cold back.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 112, NPCId = 8, LinkedQuestId = 23, ResponseType = "None", Content = "His supplies ran out days ago and no courier of mine has come back down that road alive.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 57, NPCId = 8, LinkedQuestId = 23, ResponseType = "Quest", Content = "Take this Magic Flour to him at the mountain peak. If the rite goes out, we all freeze with it.", DisplayOrder = 4, IsActive = true },
                new NPCDialogue { NPCDialogueId = 58, NPCId = 9, LinkedQuestId = 23, ResponseType = "Reward", Content = "The Queen's flour, and a courier still breathing. The rite can go on. You have bought this mountain another season.", DisplayOrder = 1, IsActive = true },
                // ── Q24: Dragons of the Frozen Peak (QuestId=24, NPCId=9=Zephyr) ──
                new NPCDialogue { NPCDialogueId = 59, NPCId = 9, LinkedQuestId = 24, ResponseType = "None", Content = "Stay a moment. The codex passed over this peak too, and what it touched did not simply die — it changed.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 89, NPCId = 9, LinkedQuestId = 24, ResponseType = "None", Content = "I cannot hold the rites while they circle the shrine — their shadows alone put out the candles.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 113, NPCId = 9, LinkedQuestId = 24, ResponseType = "None", Content = "Ice dragons, five of them. Young, but the codex made them hungry in a way no beast should be.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 60, NPCId = 9, LinkedQuestId = 24, ResponseType = "Quest", Content = "Climb the peak and slay all 5. Do it, and the Queen's borders hold one more winter.", DisplayOrder = 4, IsActive = true },
                // ── Q25: The Warden of the Ban (QuestId=25, NPCId=10=Roland) ──
                new NPCDialogue { NPCDialogueId = 61, NPCId = 10, LinkedQuestId = 25, ResponseType = "None", Content = "Halt. Beyond this line is under ban, and I am Roland, the warden who keeps it.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 62, NPCId = 10, LinkedQuestId = 25, ResponseType = "None", Content = "Wait. That cold on you — dragon frost. You came down off the peak, not up from the road.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 114, NPCId = 10, LinkedQuestId = 25, ResponseType = "None", Content = "I have watched this ban for eleven years and never once set foot inside. Now something in there has begun to stir.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 63, NPCId = 10, LinkedQuestId = 25, ResponseType = "Quest", Content = "Walk it with me and map what waits inside. I will not send you where I do not go myself.", DisplayOrder = 4, IsActive = true },
                // ── Q26: Break the Stone Guardian (QuestId=26, NPCId=10=Roland) ──
                new NPCDialogue { NPCDialogueId = 64, NPCId = 10, LinkedQuestId = 26, ResponseType = "None", Content = "Now I know why my order was told to guard this place and never enter it. The codex did not begin in the world. It began here.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 65, NPCId = 10, LinkedQuestId = 26, ResponseType = "None", Content = "And it is not finished. One of the old Seal Books lies at the heart of the ban, still holding.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 115, NPCId = 10, LinkedQuestId = 26, ResponseType = "None", Content = "A stone golem stands over it. The elders left it there to keep hands off the book — mine included.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 66, NPCId = 10, LinkedQuestId = 26, ResponseType = "Quest", Content = "Break the stone guardian and take the Golem Seal Book. It is worth more in your hands than under my ban.", DisplayOrder = 4, IsActive = true },
                // ── Q27: Break the Skeleton Army (QuestId=27, NPCId=11=Valiant Warrior) ──
                new NPCDialogue { NPCDialogueId = 67, NPCId = 11, LinkedQuestId = 27, ResponseType = "None", Content = "Back, stranger, keep your back to the rock! They come up out of the valley floor faster than I can cut them down.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 68, NPCId = 11, LinkedQuestId = 27, ResponseType = "None", Content = "This is no ordinary haunting. An ancient power is leaking somewhere near, and the dead rise faster than they fall.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 116, NPCId = 11, LinkedQuestId = 27, ResponseType = "None", Content = "There is a Seal Book buried under all this bone. I have felt it since the day the leak began.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 69, NPCId = 11, LinkedQuestId = 27, ResponseType = "Quest", Content = "Cut down 12 of them in the valley with me. Two blades may be enough where one was not.", DisplayOrder = 4, IsActive = true },
                new NPCDialogue { NPCDialogueId = 70, NPCId = 11, LinkedQuestId = 27, ResponseType = "Reward", Content = "The animals are fleeing from the abandoned village of Tide-Knell. Look into it, and find the girl Natalie.", DisplayOrder = 5, IsActive = true },
                // ── Q28: The Skull by the Well (QuestId=28, NPCId=12=Natalie) ──
                new NPCDialogue { NPCDialogueId = 71, NPCId = 12, LinkedQuestId = 28, ResponseType = "None", Content = "You can see me. Nobody has seen me in a very long time. My name is Natalie, and this village is Tide-Knell.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 117, NPCId = 12, LinkedQuestId = 28, ResponseType = "None", Content = "I cannot leave the well. I have tried. Something of me is still down in that ground, and it holds me here.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 118, NPCId = 12, LinkedQuestId = 28, ResponseType = "None", Content = "The animals knew before you did. That is why they ran. They will not drink from a well with a girl in it.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 72, NPCId = 12, LinkedQuestId = 28, ResponseType = "Quest", Content = "Please. Dig beside the old well and lift out the skull you find there. I am ready to be found.", DisplayOrder = 4, IsActive = true },
                // ── Q29: Lay Natalie to Rest (QuestId=29, NPCId=12=Natalie) ──
                new NPCDialogue { NPCDialogueId = 73, NPCId = 12, LinkedQuestId = 29, ResponseType = "None", Content = "(A weathered letter lies where Natalie once stood. It is her own hand, and it is a farewell.)", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 119, NPCId = 12, LinkedQuestId = 29, ResponseType = "None", Content = "(She writes of a book she opened as a child, of a seal she did not understand, and of the day the valley began to fill with bone.)", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 74, NPCId = 12, LinkedQuestId = 29, ResponseType = "None", Content = "Thank you for bringing my remains home. Please bury me under the ivy tree in my courtyard, where I used to sit.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 75, NPCId = 12, LinkedQuestId = 29, ResponseType = "Quest", Content = "The ancient power leak was my doing, and I have paid for it here. Take this Mystic Key — it opens the castle gates on the deserted island.", DisplayOrder = 4, IsActive = true },
                // ── Q30: Ancient Leaves of the Isle (QuestId=30, NPCId=13=Elf Guard) ──
                new NPCDialogue { NPCDialogueId = 76, NPCId = 13, LinkedQuestId = 30, ResponseType = "None", Content = "An outsider, with a Mystic Key, standing on my island. The sea should have kept you. Yet here you are.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 77, NPCId = 13, LinkedQuestId = 30, ResponseType = "None", Content = "I am the last guard of this place. I know what you carry, and I know the forest you are trying to reach.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 120, NPCId = 13, LinkedQuestId = 30, ResponseType = "None", Content = "A portal home cannot be forced. It must be grown, and for that the rite needs leaves older than the curse itself.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 78, NPCId = 13, LinkedQuestId = 30, ResponseType = "Quest", Content = "Collect 5 Ancient Leaves from the Northern Plateau. Bring them, and I will begin the rite of return.", DisplayOrder = 4, IsActive = true },
                // ── Q31: Defeat the UnderKing (QuestId=31, NPCId=13=Elf Guard) ──
                new NPCDialogue { NPCDialogueId = 79, NPCId = 13, LinkedQuestId = 31, ResponseType = "None", Content = "The leaves are enough. The rite is ready. And yet I cannot light it — something below the castle is smothering it.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 80, NPCId = 13, LinkedQuestId = 31, ResponseType = "None", Content = "The UnderKing has woken. He held the last Seal Book in his hands long before you were born.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 121, NPCId = 13, LinkedQuestId = 31, ResponseType = "None", Content = "Three seals you have already. Without his, the Origin Tree cannot be cleansed and the forest ends with the tree.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 81, NPCId = 13, LinkedQuestId = 31, ResponseType = "Quest", Content = "End his reign. Defeat the UnderKing and take the fourth book from him.", DisplayOrder = 4, IsActive = true },
                // ── Q32: Ask for the Way Home (QuestId=32, NPCId=13=Elf Guard) ──
                new NPCDialogue { NPCDialogueId = 82, NPCId = 13, LinkedQuestId = 32, ResponseType = "None", Content = "It is done. The UnderKing has fallen, and all four Seal Books are in one pair of hands for the first time in an age.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 83, NPCId = 13, LinkedQuestId = 32, ResponseType = "None", Content = "You want the way home. I will give it, but understand what waits: the Origin Tree is nearly gone.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 122, NPCId = 13, LinkedQuestId = 32, ResponseType = "None", Content = "The rite will open once and close behind you. Whatever you leave undone on this side stays undone.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 84, NPCId = 13, LinkedQuestId = 32, ResponseType = "Reward", Content = "Then go. The portal to the Elf Forest is open. Save the tree, outsider.", DisplayOrder = 4, IsActive = true },
                // ── Q33: Return with the Seals (QuestId=33, NPCId=2=Lyra) ──
                new NPCDialogue { NPCDialogueId = 85, NPCId = 2, LinkedQuestId = 33, ResponseType = "None", Content = "You came back. Through the ruins, the snow, the ban, the sea — and you are carrying all four seals.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 90, NPCId = 2, LinkedQuestId = 33, ResponseType = "None", Content = "The tree has almost no strength left. Every leaf it drops, the curse takes a little more of the forest.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 123, NPCId = 2, LinkedQuestId = 33, ResponseType = "None", Content = "Four books, four elders, four bindings broken. Set them together and the curse has nowhere left to hide.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 86, NPCId = 2, LinkedQuestId = 33, ResponseType = "Quest", Content = "Bring the four books to me here, at the roots. Hurry.", DisplayOrder = 4, IsActive = true },
                // ── Q34: Heal the Origin Tree (QuestId=34, NPCId=2=Lyra) ──
                new NPCDialogue { NPCDialogueId = 91, NPCId = 2, LinkedQuestId = 34, ResponseType = "None", Content = "The four seals are whole. I have opened the rite... but I cannot finish it.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 92, NPCId = 2, LinkedQuestId = 34, ResponseType = "None", Content = "The seals answer only to the one who won them. It must be your hand, not mine.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 124, NPCId = 2, LinkedQuestId = 34, ResponseType = "None", Content = "I am the tree's spirit. If the curse takes the roots, it takes me with them — so do not hesitate at the last step.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 93, NPCId = 2, LinkedQuestId = 34, ResponseType = "Quest", Content = "Step to the Origin Tree and set the four Seal Books upon it. Break the curse.", DisplayOrder = 4, IsActive = true },
                // ── Q35: A New Dawn (QuestId=35, NPCId=2=Lyra) ──
                new NPCDialogue { NPCDialogueId = 87, NPCId = 2, LinkedQuestId = 35, ResponseType = "None", Content = "The curse is breaking... The Origin Tree is finally healing!", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 125, NPCId = 2, LinkedQuestId = 35, ResponseType = "None", Content = "Look at the roots. Green, after all this time. The forest will remember the one who stood here today.", DisplayOrder = 2, IsActive = true },
                new NPCDialogue { NPCDialogueId = 126, NPCId = 2, LinkedQuestId = 35, ResponseType = "None", Content = "And yet the cloaked one was never found, and no one has said who broke the four bindings in the first place.", DisplayOrder = 3, IsActive = true },
                new NPCDialogue { NPCDialogueId = 88, NPCId = 2, LinkedQuestId = 35, ResponseType = "Reward", Content = "Thank you, truly. The Origin Tree is saved. But this is not the end... To be continued.", DisplayOrder = 4, IsActive = true }
            );
        }
    }
}
