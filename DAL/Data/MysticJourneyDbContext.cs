...
public DbSet<DailyLoginReward> DailyLoginRewards => Set<DailyLoginReward>();
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Quest>().HasData(
                ...
                new Quest { QuestId = 17, Title = "[Chapter 2] Trial III: The Goblin Grounds", Description = "Two trials done. The third lies south of the ruins, where goblin spear and axe bands have dug in. Break 3 of them.",                                                   Type = "Main", DefaultStatus = "NotStarted", MapName = "AutumnPumpkin",  RequiredLevel = 4,  TargetAmount = 10, RewardExperience = 250,  RewardGold = 25m,   RewardGems = 5m, ObjectiveType = "Defeat",     ObjectiveTarget = "Goblin", ObjectiveLocation = "Goblin Grounds", QuestGiverName = "Arthur", IsActive = true },
                ...
                new Quest { QuestId = 42, Title = "[Chapter 5] Heal the Origin Tree", Description = "Set the four Seal Books on the Origin Tree and break the curse.", Type = "Main", DefaultStatus = "NotStarted", MapName = "ElfForest", RequiredLevel = 12, TargetAmount = 1, RewardExperience = 400, RewardGold = 250m, RewardGems = 5m, ObjectiveType = "Interact", ObjectiveTarget = "Origin Tree", ObjectiveLocation = "Elf Forest", QuestGiverName = "Lyra", IsActive = true },
                new Quest { QuestId = 43, Title = "[Chapter 5] A New Dawn", Description = "The Origin Tree is green again. Speak with Lyra one last time.", Type = "Main", DefaultStatus = "NotStarted", MapName = "ElfForest", RequiredLevel = 12, TargetAmount = 1, RewardExperience = 300, RewardGold = 200m, RewardGems = 5m, ObjectiveType = "Talk", ObjectiveTarget = "Lyra", ObjectiveLocation = "Origin Tree", QuestGiverName = "Lyra", IsActive = true }
            );
            ...
            modelBuilder.Entity<NPCDialogue>().HasData(
                ...
                new NPCDialogue { NPCDialogueId = 85, NPCId = 2, LinkedQuestId = 41, ResponseType = "Quest", Content = "You came back carrying all four seals. Bring them to the roots.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 91, NPCId = 2, LinkedQuestId = 42, ResponseType = "Quest", Content = "Set the four Seal Books upon the Origin Tree and break the curse.", DisplayOrder = 1, IsActive = true },
                new NPCDialogue { NPCDialogueId = 87, NPCId = 2, LinkedQuestId = 43, ResponseType = "Reward", Content = "The curse is breaking. The Origin Tree is finally healing. Thank you.", DisplayOrder = 1, IsActive = true }
            );
        }
    }
}
